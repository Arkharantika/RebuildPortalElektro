                ...
                @csrf
                    ...
                    <div class="block">
                        <ul class="nav nav-tabs nav-tabs-block bg-gray-light" data-toggle="tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#btabs-animated-slideup-ask_surat">Pengajuan Surat Tugas KP</a>
                            </li>
                        </ul>
                        ...
                        <div class="block-content tab-content overflow-hidden">
                            ...
                            <div class="tab-pane fade fade-up" id="btabs-animated-slideup-ask_surat" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    @if($accPenugasankp->penugasan_kp != 1)
                                    <span class="badge badge-danger">Mohon Lengkapi Seluruh Persyaratan Sebelumnya</span>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <a href="{{url('kp/pendaftaran/ask_surat_tugas')}}" class="btn btn-alt-danger" data-wizard="finish">
                                                    Ajukan Permintaan Surat Tugas Pada Koordinator !! <i class="fa fa-angle-right ml-5"></i>
                                                </a>
                                            </div>
                                        </div>
